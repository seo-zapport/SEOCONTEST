...
@section('admin-content')
    <div class="wrapper wrapper-content clearfix">
      ...
      if ( count( $theme_group ) > 0 ) {
        ...
        $bandisplay = json_decode($theme_group->ban_dis);
                ...
                <div class="tabs-container">
                  <div class="tabs-left">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#site-webmaster" >Google Option Settings</a></li>
                        ...
                        <li><a data-toggle="tab" href="#site-banner" aria-expanded="false">Banner</a></li>
                    ...
                    <div class="tab-content">
                      <div id="site-identity" class="tab-pane active">
                       ...
                       <div id="site-webmaster" class="tab-pane">
                             <div class="tt-body panel-body">
                               <div class="col-sm-12"><h3 class="text-navy">Google SEO Rank</h3></div>
                              <div class="form-group">
                                <label class="col-md-3">Google Ranking <span class="text-danger">(*)</span></label>
                                <div class="col-md-9">
                              ...
                              <hr class="hr-line-dashed">
                               <div class="col-sm-12"><h3 class="text-navy">Google Webmaster Tools</h3></div>
                               <div class="from-group m-b clearfix">
                              ...
                              <hr class="hr-line-dashed">
                              <div class="col-sm-12"><h3 class="text-navy">Google re-CAPTCHA</h3></div>
                              <div class="form-group">
                                <label class="col-md-3">Data Site Key <span class="text-danger">(*)</span></label>
                                <div class="col-md-9">
                                  <input type="text" name="site_g_key" class="form-control" placeholder="Enter Data Site Key here" value="{{ $theme_group->data_sitekey }}">
                                </div>
                              </div>
                               <div class="form-group">
                                <label class="col-md-3">Data Secret Key <span class="text-danger">(*)</span></label>
                                <div class="col-md-9">
                      ...
                      <div id="site-banner" class="tab-pane ">
                        <div class="tt-body panel-body">
                          <div class="form-group">
                            <div class="col-md-12">
                              <h3 class="text-navy">Banner</h3>
                              <hr class="hr-line-dashed">
                               <div class="checkbox checkbox-success col-sm-12">
                                  <input type="checkbox" id="site_display_banner" name="site_display_banner" {{ ( @$theme_group->banner_stat === 'true' ) ? 'checked' : '' }} onchange="toggleStatus()">
                                  <label for="site_display_banner">Display Site Banner</label>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                              <?php 
                                  $arr_lrt = array();
                                  $arr_bt = array();
                                  foreach($banner_dis as $bandisp){
                                     list($width, $height) = getimagesize("http://qqseocontest.com/img/gallery/".$bandisp->media_name); 
                            ...
                            <div class="col-md-12 ban-form">
                                <div class="form-group">
                                  <label for="ban_left_display" class="control-label col-sm-2">Left: </label>
                                  <div class="col-sm-10">
                                    <select class="form-control" name="ban_left_display" {{ ( @$theme_group->banner_stat === 'false' ) ? 'disabled=disabled' : '' }}>
                                      <option value="_blank" >Select Banner Left</option>
                                     
                                      @foreach ($arr_lrt as $bandis) 
                                      <option value="{{ $bandis->bdid }}" @if(old('ban_left_display', $bandis->bdid) == @$bandisplay->bld_id) selected="selected" @endif>{{$bandis->category_name}} - {{ $bandis->title_name }}</option>
                                      @endforeach
                                ...
                                <div class="form-group">
                                  <label for="ban_right_display" class="control-label col-sm-2">Right: </label>
                                  <div class="col-sm-10">
                                    <select class="form-control" name="ban_right_display" {{ ( @$theme_group->banner_stat === 'false' ) ? 'disabled=disabled' : '' }}>
                                      <option value="_blank" >Select Banner Right</option>
                                     
                                      @foreach ($arr_lrt as $bandis) 
                                      <option value="{{ $bandis->bdid }}" @if(old('ban_right_display', $bandis->bdid) == @$bandisplay->brd_id) selected="selected" @endif>{{$bandis->category_name}} - {{ $bandis->title_name }}</option>
                                      @endforeach
                                ...
                                <div class="form-group">
                                  <label for="ban_bottom_display" class="control-label col-sm-2">Bottom: </label>
                                  <div class="col-sm-10">
                                    <select class="form-control" name="ban_bottom_display" {{ ( @$theme_group->banner_stat === 'false' ) ? 'disabled=disabled' : '' }}>
                                      <option value="_blank" >Select Banner Bottom</option>

                                      @foreach ($arr_bt as $bandis) 
                                      <option value="{{ $bandis->bdid }}" @if(old('ban_bottom_display', $bandis->bdid) == @$bandisplay->bbd_id) selected="selected" @endif>{{$bandis->category_name}} - {{ $bandis->title_name }}</option>
                                      @endforeach
                        ...
                        @foreach ($media as $medias)
                            <div id="details_attach" class="details_attach details_{{$medias->id}} animated fadeIn" style="display:none;">
                              ...
                              <div tabindex="0" id="attachment_id_{{$medias->id}}" class="attach-form" data-attachment_id="{{$medias->id}}">
                                      <div class="form-group">
                                          <label>URL</label>
                                          <input type="text" id="attach_url_{{$medias->id}}" name="attach_url" class="form-00000000000000control" value="{{$medias->merchant_name.'/img/gallery/'.$medias->media_name}}" disabled>
                                      </div>
                                      <div class="form-group">
                                          <label>Title</label>
