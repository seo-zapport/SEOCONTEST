            ...
            <div class="tabs-container ibox-content">
                <div id="Participants-Items">
                            ...
                            <div class="table-responsive">
                                <table class="footable table table-stripped toggle-arrow-tiny default table-bordered" data-show-toggle="false" data-paging="true">
                                    <thead>
                                        <tr>
                                            <th data-hide="all"></th>
                                    ...
                                    @if(count($register)>0)
                                        @foreach ($register as $registers)
                                            <tr data-expanded="true">
                                                ...
                                                <td><a href="{{$registers->url_web_contest}}" target="_blank" title="{{$registers->url_web_contest}}">{{$registers->url_web_contest}}</a></td>
