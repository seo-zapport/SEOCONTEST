...
@section('front-content')
	...
	<section id="banks" class="m-b">
		<h2 class="sr-only">Bank RESMI</h2>
		<div class="container">
			<div class="c-panel panel-seo-fun">
				<div class="c-panel-box c-panel-box-g c-panel-shadows">
					<h3 class="heading-3 text-center">Banks</h3>
				</div>
				<div class="panel-seo-body">
					<div class="flexwrap flex-justify-center">
						<div class="list-wrap">
							<div class="list-group-flex">
								<span class="list-item-flex"><i class="list-icons bank-mandiri"></i></span>
								<span class="list-item-flex"><i class="list-icons bank-bca"></i></span>
								<span class="list-item-flex"><i class="list-icons bank-bni"></i></span>
								<span class="list-item-flex"><i class="list-icons bank-bri"></i></span>
								<span class="list-item-flex"><i class="list-icons bank-danamon"></i></span>
							</div>
						</div>
					</div>
				</div>
