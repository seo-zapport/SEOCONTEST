...
$(function () {
    ...
    $('#theme_settings_btn_update').bind('click', function(){
        ...
        /*Banner*/
        banner_opt = $('input[name=site_display_banner]').prop('checked'),
        banner_left = $('select[name=ban_left_display]').val(),
        banner_right = $('select[name=ban_right_display]').val(),
        banner_bottom = $('select[name=ban_bottom_display]').val(),
        ...
        if($('#langname option:selected').attr('value') === ""){
         ...
         var dataSend = {
            ...
            'wa'	: 	wa,
            'banleft'   : banner_left,
            'banright'   : banner_right,
            'banbottom'   : banner_bottom,
            'bandisopt' : banner_opt,
  ...
  function toggleStatus() {
      if ($('#site_display_banner').is(':checked')) {
          $('.ban-form :input').removeAttr('disabled');
      } else {
          $('.ban-form :input').attr('disabled', true);
      }   
  }
